# The Hospital Carrying the Gap

---
episode: 15
title: "The Hospital Carrying the Gap"
topic: Shaukat Khanum Memorial Cancer Hospital & Research Centre — funding model and Pakistan's public cancer-care capacity gap
approved_angle: "The Hospital Carrying the Gap"
central_question: "How does Pakistan's largest free-cancer-care institution actually pay for itself, and what does that funding model reveal about the state's role in public health?"
thesis: "The hospital's free-treatment model is sustained by a layered cross-subsidy of paying patients, domestic zakat, and diaspora donations, which has scaled successfully so far but faces two structural pressures: it is compensating for a public-sector capacity gap the state has never closed, and its costs are partly dollar-denominated while most of its donor base is not."
story_logic: Institutional + Financial
...
The Hospital Carrying the Gap — Pakistan's public health system never built cancer-treatment capacity near the scale of the country's cancer burden, so a private, donor-funded hospital has absorbed a share of that gap far larger than any one hospital should have to carry, funded by a cross-subsidy model that works today but depends on constant fundraising growth to keep pace with rising costs.

### Central question

How does Pakistan's largest free-cancer-care institution actually pay for itself, and what does that funding model reveal about the state's role in public health?

### Thesis

The hospital's free-treatment model is sustained by a layered cross-subsidy of paying patients, domestic zakat, and diaspora donations, which has scaled successfully so far but faces two structural pressures: it is compensating for a public-sector capacity gap the state has never closed, and its costs are partly dollar-denominated while most of its donor base is not.

### Story logic

Institutional and financial, in combination. The state-versus-private division of cancer-care capacity is institutional; the mechanics that make the private version work are financial.

### Structure rationale

Five parts, approved by the user. Part 1 opens on the scale contrast and states the central question. Part 2 explains the domestic cross-subsidy mechanism. Part 3 isolates diaspora funding as its own distinct, better-documented channel. Part 4 tests the "state's missing capacity" claim on its own evidence, independent of the hospital. Part 5 stress-tests the model's sustainability and closes with a specific, honest verdict.
...
So how does a hospital give away most of what it does, year after year, and still keep its doors open?

---

## Part 2 — Who Actually Pays for Free Care
...
Zakat is the Islamic obligation to give a share of savings to those in need. For a hospital treating the poor, it functions as a direct, recurring source of funding, not a one-time gift.

The rest comes mostly from paying patients, treated at the same hospital, by the same doctors, at rates that cover the actual cost of their own care and more. In 2025, that income from paying patients made up about a quarter of the hospital's total revenue, far smaller than the donor share. [SOURCE: Shaukat Khanum Memorial Trust, audited Income and Expenditure Account, FY2025] [ANALYSIS: Net Clinical Income of Rs 10.48 billion divided by total income of Rs 38.25 billion]
...
Most of that trust, and most of that money, is raised inside Pakistan. But a meaningful share of it now comes from somewhere else entirely.

---

## Part 3 — The Money That Comes From Abroad
...
## Part 5 — Can This Model Keep Scaling
...
But they matter more here, because every rupee spent on a new building is a rupee not spent on treating a patient that year.

There's a second, quieter pressure sitting underneath all of this. Cancer treatment depends heavily on imported drugs and equipment, priced in dollars. [ANALYSIS: general dynamic affecting Pakistan's medical-import sector broadly, not a Shaukat Khanum-specific figure]

Most of the hospital's donor base gives in rupees. When the rupee weakens against the dollar, the real cost of that imported medicine and machinery rises, even if donations stay exactly the same. [ANALYSIS]
...
That's a small, carefully protected bet, not a large standing reserve. It shows the instinct to build a buffer exists.
...
1. Shaukat Khanum Memorial Trust — Annual Report 2025 (user-supplied PDF, read in full): cumulative philanthropic spending (Rs 125bn, 1994-2025), 75% free-treatment rate, SKMT Revenue 2025 breakdown, Karachi construction spend and timeline, Peshawar and Lahore updates.
