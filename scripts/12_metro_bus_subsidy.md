# The Ride That Costs More Than the Ticket

---
episode: 12
title: "The Ride That Costs More Than the Ticket"
...
Do Pakistan's flagship Metro Bus and BRT systems solve urban mobility, or are they subsidy commitments governments underprice at launch and cannot sustain?
...
Financial and institutional. The story needs hard unit economics, fare against cost per ride, and an institutional explanation of why several separate governments made the same underpricing decision independently.
...
## Part 1 — The Ride That Costs More Than the Ticket

In Lahore, a ride on the Orange Line, the city's rail based metro, costs between twenty five and forty five rupees depending on distance. [SOURCE: Punjab Masstransit Authority, fare policy, accessed 2026] That fare is not close to what the ride actually costs. To repay the loan that built the line and cover what it costs to run each day, a single trip would need to be priced at roughly one hundred seventy one rupees. One hundred twenty eight rupees of that figure is debt service on construction loans. The other forty three rupees is the daily cost of running the trains. [REPORTED: Express Tribune; VERIFY exact publication date before recording]
...
The Orange Line, Lahore's rail based system, was already introduced in Part One: a fare of twenty five to forty five rupees against a break even cost near one hundred seventy one. Its reported annual subsidy runs seven to eight billion rupees, and a separate projection puts the province's total exposure over twenty years at one hundred ninety three billion rupees. [REPORTED: Express Tribune]

Peshawar's Bus Rapid Transit system shows the same pattern with a sharper construction overrun. It was budgeted at forty nine point four billion rupees in 2017. By the time it opened in 2020, the cost had climbed to seventy point seven billion, an increase of more than twenty billion rupees during construction alone. [SOURCE: Dawn, reporting on project cost revisions] A passenger today pays twenty eight rupees for a ride the system says costs eighty, with the government covering the fifty rupee difference directly. [REPORTED: multiple Pakistani outlets] The province's reported annual subsidy for the system has risen from four billion rupees to five billion within the past year, and separately reported losses have exceeded six billion rupees in a single year. [REPORTED, 2024-2025 reporting; VERIFY the exact relationship between the subsidy figure and the larger loss figure before recording]

Multan's Metrobus, the smallest system in the group, cost approximately twenty nine billion rupees to build. [REPORTED] Its published fare today is twenty five rupees. [SOURCE: Punjab Masstransit Authority, fare policy, accessed 2026] Separate reporting suggests that fare was due to rise by a third in early 2026. The transit authority's own published fare schedule, checked directly for this episode, still shows the lower figure. [VERIFY current Multan fare before recording]

Karachi's Green Line, the newest system and the only one built with direct federal funding, charges between fifteen and fifty five rupees depending on distance, with the federal government subsidising the top of that range to hold it there. [REPORTED] It was designed to carry up to three hundred thousand passengers a day at full capacity. How close it has come to that figure could not be confirmed for this episode. [VERIFY current Green Line ridership before recording]

Five systems, in four cities, built by different provincial and federal authorities that did not coordinate with one another. The same fare below cost pattern appears in every one.
...
1. Punjab Masstransit Authority — official fare policy page, accessed 2026-08-22. Current fares for Lahore Metrobus (Rs 30), Multan Metrobus (Rs 25), and Orange Line/Metrobus transfer fares (Rs 25-45).
2. Express Tribune — reporting on Auditor-General findings on Lahore Metro Bus construction overpayments. [VERIFY specific article date]
3. Express Tribune — "OLMT's revenue shortfall soars" and related reporting on Orange Line break-even fare and subsidy. [VERIFY specific article date]
4. Express Tribune — reporting on projected 20-year Orange Line subsidy of Rs 193 billion. [VERIFY specific article date]
5. Pakistan Institute of Development Economics (PIDE) — "Exposing the Metro Bus Scheme." Islamabad Metro Bus ridership target and 2016 actual figures, capital cost. [Direct fetch of pide.org.pk blocked in this session; relied on search-result synthesis — VERIFY via direct access before recording]
6. Profit by Pakistan Today — reporting on the June 2025 Islamabad Metro Bus fare hike to Rs 100 and its reversal within days. [VERIFY specific article dates]
7. Dawn — reporting on Peshawar BRT project cost revisions, 2017-2020. [VERIFY specific article dates]
8. Multiple Pakistani outlets — reporting on Peshawar BRT fare (Rs 28), operating cost (Rs 80/passenger), and subsidy (Rs 50/passenger). [VERIFY specific sources and dates]
9. Eno Center for Transportation — US national farebox recovery ratio data.
10. TransitWiki — international farebox recovery ratio reference data (North America, Europe, Canada, Asia).
11. Pakistani press reporting, November 2025 — combined annual subsidy figure (~Rs 21 billion) across Lahore, Islamabad/Rawalpindi, and Multan systems. [VERIFY primary outlet and reconcile against a separate, similar but not identical figure found in other reporting before recording]
