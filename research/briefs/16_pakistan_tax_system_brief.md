...
**Classification: REPORTED, flagged `[VERIFY]`.** This is a "current status" claim (no NFC award has superseded the 7th as of the episode's air date) that needs a direct, dated confirmation — e.g., a current Ministry of Finance or NFC Secretariat statement — before it is stated flatly in the script. The historical sequence (8th constituted without an award, 9th constituted 2015) is corroborated across multiple sources and can be treated with more confidence than the "still current in 2026" framing.
...
- Following devolution, provinces created their own collecting authorities for sales tax on services: **Sindh Revenue Board (SRB)**, **Punjab Revenue Authority (PRA)**, **Khyber Pakhtunkhwa Revenue Authority (KPRA)**, and **Balochistan Revenue Authority (BRA)**. BRA's Sales Tax on Services regime is confirmed to have taken effect 1 July 2015 (BRA's own stated commencement date, general rate 15%, 19.5% on telecom services). Exact founding dates for SRB, PRA, and KPRA were not independently confirmed with a primary document in this research pass and are flagged `[VERIFY]`.
...
|---|---|---|---|
| V1 | Whether the 7th NFC Award's 57.5/42.5 formula remains the current operative formula (no NFC award since 2010) | Multiple secondary sources agree on the history through 2015 (9th NFC constituted), but no source in this pass confirms the status as of 2026 with a dated primary statement | Pull a current Ministry of Finance / NFC Secretariat statement or budget document dated 2025-26 confirming no new award has been signed |
...
| V5 | Exact founding years of SRB, PRA, and KPRA | Only BRA's 2015 commencement date was directly confirmed; the others are inferred/approximate | Confirm founding legislation dates for each authority before citing them |
